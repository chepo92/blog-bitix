...
for f in static/assets/images/logotypes/*.svg; do inkscape -w 750 "$f" --export-background white --export-type png --export-filename "static/assets/images/structured-data/$(basename ${f%.*})-750.png"; done;
