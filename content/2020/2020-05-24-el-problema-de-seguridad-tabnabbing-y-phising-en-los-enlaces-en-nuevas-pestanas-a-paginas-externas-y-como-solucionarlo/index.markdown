...
{{< image
    gallery="true"
    image1="image:link-target-blank-1.png" optionsthumb1="650x450" title1="Página con enlaces a otras páginas abiertas en una ueva pestaña"
...
{{< code file="unknown.xhtml" language="html" options="hl_lines=7" >}}
...
{{< image
    gallery="true"
    image1="image:link-target-blank-2.png" optionsthumb1="650x450" title1="Problema de tabnnabing en enlaces que abren páginas en uneva pestaña" >}}
{{< image
    gallery="true"
    image1="image:link-target-blank-3.png" optionsthumb1="650x450" title1="Problema de tabnnabing en enlaces que abren páginas en uneva pestaña"
...
{{< image
    gallery="true"
    image1="image:link-target-blank-4.png" optionsthumb1="650x450" title1="La variable window.opener es nula en el enlace seguro"
